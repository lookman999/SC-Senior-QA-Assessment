...
import { CartPage, type CartItem } from '../pages/cart-page';
import { CheckoutPage } from '../pages/checkout-page';
import { PaymentPage } from '../pages/payment-page';
import type { Account } from '../data/account';
import type { AccountLifecycle } from '../support/account-lifecycle';
import type { CatalogClient } from '../api/catalog-client';
import { productsSchema, validate } from '../api/contracts';

// These are executable step definitions; test.step exposes them in reports and traces.
export class UiSteps {
  ...
  whenAccountIsRegistered(lifecycle: AccountLifecycle) {
  ...
  whenProductsAreAdded(catalog: CatalogClient): Promise<CartItem[]> {
  ...
  thenCartMatches(items: CartItem[]) {
  ...
  thenCheckoutMatches(account: Account, items: CartItem[]) {
